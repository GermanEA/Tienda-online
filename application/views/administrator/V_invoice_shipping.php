...
<div class="content-info">
    <div class="content-header">
        <span><?= $invoice[0]->codigo_envio; ?></span>
    </div>
    ...
    <div id="content-body" class="content-table content-invoice-wrapper">
        <div class="invoice-wrapper">
            ...
            <div class="data-wrapper">
                <div class="data-costumer">
                    <div class="data-header">Enviar a</div>
                ...
                <div class="data-invoice">
                    <span class="data-header">ENVÍO</span>
                    <span>Envío: <?= $invoice[0]->codigo_envio; ?></span>
                    <span>Fecha de envío: <?= date("d-m-Y", strtotime($invoice[0]->fecha_pedido)); ?></span>
        ...
        <div class="btn-wrapper text-center">
            <button type="button" class="btn btn-original" onclick="window.location.href = '<?= base_url('/administrator/invoice/showAllShipping'); ?>';">Volver</button>
        </div>
    </div>
